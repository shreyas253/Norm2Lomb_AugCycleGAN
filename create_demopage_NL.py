...
methods = [ "./audio/ORIG_norm",
            "./audio/ORIG_Lomb",
            "./audio/CYC_15_FINAL",
            "./audio/AUG_IN15_final_low",
            "./audio/AUG_IN15_final_mid",
            "./audio/AUG_IN15_final_high"]

method_titles = ['Normal Reference',
                 'Lombard Reference',
                 'Mapped CycleGAN',
                 'Mapped Augmentd CycleGAN (Low Lombard)',
                 'Mapped Augmentd CycleGAN (Mid Lombard)',
                 'Mapped Augmentd CycleGAN (High Lombard)']
